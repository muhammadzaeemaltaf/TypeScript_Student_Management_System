...
async function addStudent() {
    ...
    console.log(`Student ${student.name} added successfully with ID: ${student.id}`);
}
const courses = [
    {
        name: "TypeScript",
...
async function enroll() {
    ...
    if (student.course.includes(selectedCourse)) {
        ...
        if (student.balance >= courseDetail.cost) {
            ...
            console.log(`Dear ${student.name}, You successfully enrolled in ${selectedCourse}. Remaining balance: $${student.balance}`);
        }
        else {
...
async function payFee() {
    ...
    if (student.feeStatus === "Paid") {
        console.log(`Dear ${student.name}, you have already paid your tuition fee.`);
        ...
        console.log(`${student.name}, you have successfully paid your tuition fee of $${pay.fee}`);
        console.log(`Your remaining balance is $${student.balance}.`);
    }
}
